# Skill-Test-Xapiens
Soal
Untuk mengerjakan soal skill, pastikan anda mengerjakan menggunakan bahasa yang anda pilih ketika mendaftar
...
Soal Algoritma
Jawaban dapat dirunning dan memberikan output pada console atau terminal

1. Soal Pertama 10 Point
